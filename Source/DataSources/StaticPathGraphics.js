...
define([
     ...
     */
    function StaticPathGraphics(options) {
    ...
    defineProperties(StaticPathGraphics.prototype, {
        /**
         * Gets the event that is raised whenever a property or sub-property is changed or modified.
         * @memberof StaticPathGraphics.prototype
         * @type {Event}
         * @readonly
         */
        definitionChanged : {
     ...
     *
     * @param {StaticPathGraphics} [result] The object onto which to store the result.
     * @returns {StaticPathGraphics} The modified result parameter or a new instance if one was not provided.
     */
    StaticPathGraphics.prototype.clone = function(result) {
        if (!defined(result)) {
            return new StaticPathGraphics(this);
        }
     ...
     *
     * @param {StaticPathGraphics} source The object to be merged into this object.
     */
    StaticPathGraphics.prototype.merge = function(source) {
