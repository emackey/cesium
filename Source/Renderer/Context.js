...
define([
    ...
    Context.prototype.createRenderbuffer = function(description) {
        ...
        var width = typeof description.width !== 'undefined' ? description.width : gl.drawingBufferWidth;
        var height = typeof description.height !== 'undefined' ? description.height : gl.drawingBufferHeight;
